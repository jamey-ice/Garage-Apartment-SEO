...
const CITY_DATA: Record<string, CityData> = {
  'fort-worth': {
    ...
    costContext: 'Fort Worth sits in the middle of the DFW cost range. Labor costs are slightly lower than north Dallas suburbs. Permit fees run $800–$2,500 for typical ADU projects. Most garage conversions in Fort Worth run $40,000–$100,000. Above-garage apartments: $80,000–$180,000. Detached ADUs: $100,000–$280,000.',
  ...
  'mansfield': {
    ...
    costContext: 'Mansfield construction costs are mid-range for the DFW area. Garage conversions: $40,000–$95,000. Above-garage apartments: $80,000–$180,000. Detached ADUs: $100,000–$260,000. The combination of reasonable costs and growing property values makes the investment math attractive.',
    ...
    whyBuilding: 'Mansfield\'s proximity to Fort Worth, Arlington, and major employment corridors drives steady rental demand. Garage apartments in Mansfield typically rent for $950–$1,500/month. The Mansfield ISD draws families, creating strong demand for well-designed living space.',
    faqs: [
      ...
      { q: 'How much does a garage apartment cost in Mansfield?', a: 'Garage conversions in Mansfield typically run $40,000–$95,000. Above-garage apartments: $80,000–$180,000. Detached ADUs: $100,000–$260,000.' },
      ...
      { q: 'How long does it take to build a garage apartment in Mansfield?', a: 'Garage conversions: 3–5 months. Above-garage builds: 4–7 months. Detached ADUs: 5–8 months.' },
    ],
  },
  'aledo': {
    name: 'Aledo',
    ...
    costContext: 'Aledo and Parker County construction costs are mid-range, though finish expectations in this market tend to be higher. Garage conversions: $42,000–$100,000. Above-garage apartments: $82,000–$185,000. Detached ADUs and guest houses: $110,000–$290,000.',
    popularProjects: 'Detached guest houses and multi-generational living suites are the dominant project type in Aledo — the large lots make them highly feasible. Garage conversions for in-law suites or rental income are also common, particularly in neighborhoods closer to Aledo\'s town center.',
    whyBuilding: 'Aledo\'s reputation for excellent schools and quality of life makes it a magnet for families — and a strong rental market for well-designed garage apartments and guest houses. Rental rates in the Aledo area typically run $1,000–$1,600/month. Large lots also mean ADU projects can be designed with real separation and privacy.',
    faqs: [
      ...
      { q: 'How much does a garage apartment cost in Aledo?', a: 'Garage conversions: $42,000–$100,000. Above-garage apartments: $82,000–$185,000. Detached ADUs and guest houses: $110,000–$290,000.' },
      ...
      { q: 'How long does it take to build a garage apartment in Aledo?', a: 'Garage conversions: 3–5 months. Detached ADUs and guest houses: 5–9 months depending on complexity.' },
    ],
  },
  'denton': {
    name: 'Denton',
    ...
    costContext: 'Denton has some of the more affordable construction costs in DFW — lower than north DFW suburbs and Southlake. Garage conversions: $38,000–$90,000. Above-garage apartments: $75,000–$175,000. Detached ADUs: $95,000–$250,000. The lower costs and strong rental market make Denton an attractive ADU market.',
  ...
  'burleson': {
    ...
    state: 'TX',
    slug: 'burleson',
    heroSubtitle: 'South Fort Worth\'s growing neighbor — affordable lots and a strong case for ADU investment.',
    intro: 'Burleson sits just south of Fort Worth, straddling Tarrant and Johnson counties — close to everything Fort Worth offers while maintaining its own distinct community character. Growing steadily with new residential development and a strong sense of community, Burleson homeowners are increasingly building garage apartments and ADUs to generate rental income or create flexible living space for family.',
    ...
    costContext: 'Burleson offers some of the more affordable ADU construction costs in the greater Fort Worth area, reflecting the local labor market and land costs. Garage conversions: $38,000–$88,000. Above-garage apartments: $75,000–$170,000. Detached ADUs: $95,000–$250,000.',
    popularProjects: 'Garage conversions for rental income are the most popular project type in Burleson. Detached ADUs on the area\'s larger lots are a growing trend. Multi-generational builds — especially for parents or adult children — are a natural fit for Burleson\'s family-oriented community.',
    whyBuilding: 'Burleson\'s proximity to Fort Worth employment, medical corridors, and major highways makes it a practical base for renters. Garage apartments in Burleson typically rent for $850–$1,350/month. Lower construction costs relative to the north DFW suburbs mean better return-on-investment math for income-focused projects.',
    faqs: [
      ...
      { q: 'How much does a garage apartment cost in Burleson?', a: 'Garage conversions in Burleson typically run $38,000–$88,000. Above-garage apartments: $75,000–$170,000. Detached ADUs: $95,000–$250,000.' },
      ...
      { q: 'How long does it take to build a garage apartment in Burleson?', a: 'Garage conversions: 3–5 months. Detached ADUs: 5–8 months from first consultation to final walkthrough.' },
    ],
  },
  'benbrook': {
    name: 'Benbrook',
    ...
    costContext: 'Benbrook tracks closely with Fort Worth pricing — one of the most cost-effective markets in Tarrant County. Garage conversions: $38,000–$95,000. Above-garage apartments: $75,000–$175,000. Detached ADUs: $95,000–$260,000. Permit fees are typically lower than larger DFW cities.',
    popularProjects: 'Garage conversions in established neighborhoods with detached two-car garages. Detached ADUs on larger lots near the lake. In-law suite builds for multi-generational families — a strong and growing segment in Benbrook.',
    whyBuilding: 'Benbrook\'s proximity to Fort Worth (10–15 minutes to downtown), Lake Benbrook recreation, and stable neighborhoods make it an attractive market for long-term rental ADUs. A well-finished garage apartment here can rent for $950–$1,400/month — delivering strong cash-on-cash returns given the lower construction costs.',
    faqs: [
      ...
      { q: 'How much does a garage apartment cost in Benbrook?', a: 'Garage conversions in Benbrook typically run $38,000–$95,000. Above-garage apartments are $75,000–$175,000. Detached ADUs range from $95,000–$260,000.' },
      ...
      { q: 'What\'s the rental market like in Benbrook?', a: 'Strong and consistent. The lakeside location and proximity to Fort Worth make Benbrook ADUs attractive to renters. Expect $950–$1,400/month depending on size and finish.' },
    ],
  },
  'haltom-city': {
    name: 'Haltom City',
    ...
    costContext: 'Haltom City is one of the most affordable ADU markets in DFW. Garage conversions: $35,000–$85,000. Above-garage apartments: $70,000–$160,000. Detached ADUs: $90,000–$235,000. Lower land and labor costs than central Fort Worth make Haltom City attractive for investment-focused ADU projects.',
    popularProjects: 'High-volume rental ADU conversions of detached garages — the core project type here. Investors and homeowners alike are capitalizing on the older housing stock and strong renter demand. Multi-generational builds for extended families are also common.',
    whyBuilding: 'Haltom City\'s renter-heavy demographic and proximity to major employers make it a reliable ADU rental market. Garage apartments here rent for $850–$1,300/month. With lower construction costs than most DFW cities, the ROI math works well for investment-focused projects.',
    faqs: [
      ...
      { q: 'How much does a garage conversion cost in Haltom City?', a: 'Haltom City is one of the most affordable ADU markets in DFW. Garage conversions run $35,000–$85,000. Detached ADUs range from $90,000–$235,000.' },
      { q: 'What\'s the rental demand like in Haltom City?', a: 'Strong. The city\'s working-class renter base and proximity to Fort Worth employment create consistent demand for affordable rental units. Expect $850–$1,300/month for a well-finished ADU.' },
  ...
  'white-settlement': {
    ...
    costContext: 'White Settlement offers affordable ADU construction costs comparable to Haltom City and Benbrook. Garage conversions: $36,000–$88,000. Above-garage apartments: $72,000–$165,000. Detached ADUs: $92,000–$245,000.',
    ...
    whyBuilding: 'The NAS JRB Fort Worth rental market is uniquely stable — military families rotate in and out on predictable schedules, creating consistent turnover demand for quality short- and long-term rentals. A well-finished ADU near the base can rent for $900–$1,350/month.',
    faqs: [
      ...
      { q: 'What makes White Settlement a good ADU market?', a: 'The proximity to NAS JRB Fort Worth and Lockheed Martin creates a stable base of renters — military families and defense workers who need quality housing close to work.' },
      { q: 'How much does a garage apartment cost in White Settlement?', a: 'Garage conversions typically run $36,000–$88,000. Detached ADUs range from $92,000–$245,000.' },
  ...
  'hurst': {
    ...
    state: 'TX',
    slug: 'hurst',
    heroSubtitle: 'Part of the HEB mid-cities market — centrally located between Fort Worth and Dallas with strong rental demand.',
    intro: 'Hurst is the northernmost of the three HEB cities (Hurst, Euless, Bedford) — an established mid-cities suburb strategically positioned between Fort Worth and Dallas along the Highway 183 corridor. The city\'s proximity to DFW Airport, major employers like Bell Helicopter and American Airlines, and easy access to both downtowns creates strong, diverse rental demand. Older neighborhoods with detached garages are common, and the ADU market here is driven by both renters and multi-generational families.',
    ...
    costContext: 'Hurst tracks with mid-range DFW pricing. Garage conversions: $40,000–$95,000. Above-garage apartments: $80,000–$180,000. Detached ADUs: $100,000–$260,000. Proximity to DFW Airport and major employers supports strong rental rates.',
    ...
    whyBuilding: 'Hurst\'s central location makes it one of the most versatile rental markets in Tarrant County — close to DFW Airport, major employment centers, and both downtowns. ADUs here rent for $1,000–$1,500/month. The combination of location and affordable construction costs creates strong ROI.',
    faqs: [
      ...
      { q: 'How much does a garage apartment cost in Hurst?', a: 'Garage conversions in Hurst typically run $40,000–$95,000. Detached ADUs range from $100,000–$260,000.' },
      { q: 'What\'s the rental market like in Hurst?', a: 'Strong and diverse. DFW Airport, Bell Helicopter, American Airlines, and easy access to both downtowns drive consistent rental demand. Expect $1,000–$1,500/month for a well-finished ADU.' },
  ...
  'euless': {
    ...
    costContext: 'Euless offers competitive ADU construction costs reflecting its mid-cities location. Garage conversions: $40,000–$95,000. Above-garage apartments: $80,000–$185,000. Detached ADUs: $100,000–$265,000.',
    ...
    whyBuilding: 'Euless\'s proximity to DFW Airport and the sports and entertainment district creates one of the most reliable rental markets in Tarrant County. ADUs here attract long-term renters who work nearby. Expect $1,000–$1,500/month for a well-finished unit.',
    faqs: [
      ...
      { q: 'How much does a garage apartment cost in Euless?', a: 'Garage conversions run $40,000–$95,000. Detached ADUs range from $100,000–$265,000.' },
  ...
  'bedford': {
    ...
    state: 'TX',
    slug: 'bedford',
    heroSubtitle: 'The most established of the HEB cities — mature neighborhoods and strong multi-generational ADU demand.',
    intro: 'Bedford is the southernmost and most established of the three HEB cities — known for its quality schools, mature neighborhoods, and long-tenured homeowners. The city sits between Euless and Hurst along the mid-cities corridor, offering easy access to DFW Airport, major employers, and both downtowns. ADU projects in Bedford are heavily driven by multi-generational living — homeowners adding space for aging parents or adult children — alongside a growing segment of rental-focused builds.',
    ...
    costContext: 'Bedford pricing is comparable to Hurst and Euless. Garage conversions: $42,000–$100,000. Above-garage apartments: $82,000–$185,000. Detached ADUs: $105,000–$270,000. The city\'s established neighborhoods and quality housing stock support strong resale and rental values.',
    ...
    whyBuilding: 'Bedford\'s stable, established character attracts quality long-term tenants. ADUs here rent for $1,050–$1,550/month. The city\'s strong school district and central DFW location mean low vacancy rates and tenant quality above the metro average.',
    faqs: [
      ...
      { q: 'How much does an ADU cost in Bedford?', a: 'Garage conversions typically run $42,000–$100,000. Detached ADUs range from $105,000–$270,000.' },
      { q: 'What\'s the most common ADU type in Bedford?', a: 'Multi-generational guest houses are the most common project — homeowners adding space for aging parents or adult children who want independent living nearby.' },
  ...
  'north-richland-hills': {
    ...
    heroSubtitle: 'One of the largest Tarrant County suburbs — established neighborhoods, large lots, and growing ADU demand.',
    intro: 'North Richland Hills is one of the largest cities in Tarrant County, covering a large swath of northeast Fort Worth territory with a mix of established 1970s–1990s neighborhoods and newer development near the 820 loop. The city has a diverse housing stock — many homes with detached garages, large corner lots, and alley-accessed properties that are well-suited for ADU projects. NRH is an increasingly popular market for both rental ADUs and multi-generational builds.',
    ...
    costContext: 'NRH pricing is competitive with Fort Worth. Garage conversions: $40,000–$98,000. Above-garage apartments: $80,000–$182,000. Detached ADUs: $100,000–$265,000. The city\'s large lot sizes make detached ADU builds particularly practical.',
    ...
    whyBuilding: 'North Richland Hills combines the affordability of northeast Tarrant County with access to major employment corridors along Loop 820 and the Northeast Mall area. ADUs here rent for $1,000–$1,500/month. The city\'s size and diverse neighborhoods create multiple sub-markets for rental demand.',
    faqs: [
      ...
      { q: 'How much does a garage apartment cost in North Richland Hills?', a: 'Garage conversions run $40,000–$98,000. Detached ADUs range from $100,000–$265,000.' },
      ...
      { q: 'What ADU type works best on a large NRH lot?', a: 'Larger lots in NRH are excellent for detached ADUs — standalone structures that maximize privacy for both the homeowner and tenant.' },
    ],
  },
  'keller': {
    name: 'Keller',
    ...
    costContext: 'Keller is a premium market reflecting higher incomes and finish expectations. Garage conversions: $50,000–$115,000. Above-garage apartments: $95,000–$210,000. Detached ADUs: $120,000–$320,000. The city\'s large lots and high property values mean ADUs add significant equity.',
    ...
    whyBuilding: 'Keller\'s large lots, high incomes, and strong property values create ideal conditions for premium ADU investment. A well-designed detached guest house here can add $120,000–$250,000 to property value. Even rental-focused builds benefit from Keller\'s proximity to DFW Airport and major employers.',
    faqs: [
      ...
      { q: 'How much does a guest house cost in Keller?', a: 'Keller projects are typically premium builds. Detached guest houses run $120,000–$320,000. Above-garage apartments are $95,000–$210,000.' },
      { q: 'What\'s the most common ADU project in Keller?', a: 'Premium detached guest houses for aging parents and adult children — designed for independent living with high-end finishes and accessibility features.' },
  ...
  'colleyville': {
    ...
    costContext: 'Colleyville is comparable to Southlake in pricing. Garage conversions: $60,000–$130,000. Above-garage apartments: $110,000–$230,000. Detached ADUs and guest houses: $150,000–$450,000+. Premium finishes are standard, and property values support the investment.',
    ...
    whyBuilding: 'Colleyville\'s estate-lot character and premium property values create ideal conditions for high-end ADU investment. A luxury guest house here can add $150,000–$350,000+ to property value. The city\'s proximity to DFW Airport and Southlake Town Square makes it attractive for executive-level long-term rentals.',
    faqs: [
      ...
      { q: 'How much does a luxury guest house cost in Colleyville?', a: 'Colleyville projects are premium builds. Detached guest houses typically run $150,000–$450,000+, reflecting the market\'s finish expectations and property values.' },
      { q: 'What style of ADU fits Colleyville homes?', a: 'Architecturally matched guest houses that complement the primary residence. We design for cohesion — the guest house should look like it belongs.' },
