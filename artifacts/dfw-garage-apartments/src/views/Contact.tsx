...
const CITIES = [
  'Fort Worth', 'Dallas', 'Arlington', 'Mansfield', 'Aledo', 'Denton',
  'Burleson', 'Southlake', 'Benbrook', 'Haltom City', 'White Settlement',
  'Hurst', 'Euless', 'Bedford', 'North Richland Hills', 'Keller',
  'Colleyville', 'Other',
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-7">
            ...
            <p className="text-lg text-muted-foreground font-sans mb-10 leading-relaxed">
              Tell us a little about your property and what you&apos;re thinking. We&apos;ll reach out to schedule a conversation and help you figure out the next step &mdash; no pressure, no obligation.
            </p>
              ...
              {!isSuccess && (
                <div className="flex border-b border-border">
                  {['Project Type', 'Your Details', 'Contact Info'].map((label, i) => (
                    ...
                    >
                      <span
                        className={`inline-flex items-center justify-center w-5 h-5 rounded-full text-[10px] mr-1.5 ${
                          step === i + 1
                  ...
                  <form onSubmit={handleSubmit} className="relative min-h-[380px]">
                    ...
                    {step === 1 && (
                      <div className="space-y-6">
                        ...
                        <p className="text-muted-foreground text-sm font-sans">
                          Select one to get started &mdash; no commitment required.
                        </p>
                        <div className="grid grid-cols-2 gap-3">
                          {PROJECT_TYPES.map((type) => (
                            <button
                              ...
                              className={`border-2 p-5 transition-all duration-200 flex flex-col items-center text-center gap-3 hover:border-accent hover:bg-accent/5 focus:outline-none ${
                            ...
                            >
                              <type.icon
                                className={`w-7 h-7 ${
                                  formData.projectType === type.id ? 'text-accent' : 'text-primary'
                                }`}
                              />
                              <span className="font-bold font-sans text-sm leading-tight">
                                {type.title}
                              </span>
                            </button>
                          ))}
                    ...
                    {step === 2 && (
                      <div className="space-y-6">
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="city" className="text-foreground font-bold text-sm">
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                            {USE_CASES.map(uc => (
                              <button
                                ...
                                className={`text-left border px-4 py-3 text-sm font-medium transition-all font-sans ${
                                  formData.useCase === uc
                          ...
                          <div className="grid grid-cols-2 gap-2">
                            {TIMELINES.map(t => (
                              <button
                                ...
                                className={`border px-4 py-3 text-sm font-medium transition-all font-sans text-center ${
                                  formData.timeline === t
                                    ? 'border-accent bg-accent/10 text-accent'
                                    : 'border-border hover:border-primary'
                                }`}
                        ...
                        <div className="flex justify-between pt-4">
                          <Button
                            ...
                            variant="outline"
                            onClick={() => setStep(1)}
                            className="rounded-none px-6 py-5 text-xs uppercase tracking-widest font-bold"
                          >
                            &larr; Back
                          </Button>
                          <Button
                    ...
                    {step === 3 && (
                      <div className="space-y-5">
                        <h3 className="font-serif text-2xl font-bold text-foreground">
                          Where should we send your project info?
                        </h3>
                        ...
                        <div className="space-y-1.5">
                          ...
                          <Input
                            ...
                            placeholder="e.g. 1234 Oak St, Fort Worth, TX"
                            className="rounded-none border-border focus-visible:ring-accent"
                          />
                        </div>
                        <div className="space-y-1.5">
                          ...
                          <Textarea
                            ...
                            placeholder="Tell us anything specific about your property or goals&hellip;"
                            className="rounded-none border-border focus-visible:ring-accent resize-none"
                          />
                        </div>
                        <p className="text-xs text-muted-foreground font-sans">
                          Or call us at{' '}
                          <a href="tel:+18176319803" className="text-primary font-bold hover:underline">
                            (817) 631-9803
                          </a>
                          . We&apos;re based in Fort Worth and serve the entire DFW metro.
                        </p>
          ...
          <div className="lg:col-span-5 space-y-10">
            ...
            <div className="bg-primary text-white p-8">
              <h3 className="font-serif text-xl font-bold mb-6 border-b border-white/20 pb-4">
                Contact Info
              </h3>
              <ul className="space-y-5">
                ...
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+18176319803" className="text-white/70 text-sm hover:text-accent transition-colors">
                      (817) 631-9803
                    </a>
                  </div>
                </li>
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@6thavehomes.com" className="text-white/70 text-sm hover:text-accent transition-colors break-all">
                      info@6thavehomes.com
                    </a>
                  </div>
                </li>
              </ul>
            ...
            <div className="bg-card p-6 border-l-4 border-accent">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-muted-foreground text-sm">&middot; 120+ Google Reviews</span>
              </div>
              <p className="text-muted-foreground font-sans text-sm leading-relaxed italic">
                &ldquo;They handled everything &mdash; permits, zoning, construction. We just showed up for the final walkthrough. Truly one team from start to finish.&rdquo;
              </p>
              <p className="text-xs font-bold text-foreground mt-3">&mdash; Marcus H., Fort Worth</p>
            </div>
