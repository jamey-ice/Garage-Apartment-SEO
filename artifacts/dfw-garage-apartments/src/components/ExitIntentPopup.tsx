...
export function ExitIntentPopup() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      await fetch("https://formspree.io/f/mykbroag", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          email,
          formType: "exit-intent-guide-signup",
          _subject: "Exit Intent Guide Signup - DFW Garage Apartments",
    ...
    a.href = "/dfw-garage-apartment-guide.pdf";
    a.download = "DFW-Garage-Apartment-Guide.pdf";
    a.click();
    setSubmitted(true);
  };
