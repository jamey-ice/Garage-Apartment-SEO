...
export function Footer() {
  ...
  const schema = {
    ...
    "description": "Garage apartment and ADU construction company serving the Dallas-Fort Worth area. Powered by 6th Ave Homes.",
  ...
  useEffect(() => {
    let script = document.querySelector('#local-business-schema') as HTMLScriptElement | null;
    if (!script) {
